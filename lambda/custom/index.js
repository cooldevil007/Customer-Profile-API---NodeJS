...
const APP_NAME = "Customer Profile"
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speechText = 'Welcome to Alexa customer profile API demo skill. You can ask what is my email or what is my mobile number. What do you want to do? ';
    const reprompt = 'Say what is my email';
...
const ProfileNameIntentHandler = {
  ...
  async handle(handlerInput) {
    ...
    try {
      ...
      const speechResponse = `Welcome , ${profileName}`;
